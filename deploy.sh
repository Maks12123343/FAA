...
settings = {
  ...
  "rewrite_api_key": os.environ.get("FAA_REWRITE_KEY", ""),
  "rewrite_model": os.environ.get("FAA_REWRITE_MODEL", "gpt-5.5"),
  "rewrite_api_url": os.environ.get("FAA_REWRITE_API_URL", "https://a6api.com/v1/chat/completions"),
  "rewrite_reasoning_effort": os.environ.get("FAA_REWRITE_REASONING_EFFORT", "high"),
